<div class="col-lg-3 col-md-3">
    <aside class="aside-policy pt-5">
        ...
        <div class="list-group mb-4">
            ...
            <a href="#" class="list-group-item {{ (request()->segment(2)=="email")?"active":"" }}">Change Email</a>
            <a href="#" class="list-group-item {{ (request()->segment(2)=="password")?"active":"" }}">Change Password</a>
